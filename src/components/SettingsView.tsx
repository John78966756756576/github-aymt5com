    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        >
          <div className="bg-[#1a1a1a]/80 backdrop-blur-lg rounded-xl border border-[#2a2a2a] p-6">
            <div className="flex items-center space-x-2 mb-6">
              <Bell className="w-5 h-5" style={{ color: currentTheme.color }} />
                ...
                <div key={notification.id} className="flex items-center justify-between">
                  ...
                  <motion.button
                    ...
                    className={`w-12 h-6 rounded-full relative ${
                      notification.enabled ? 'theme-bg' : 'bg-[#2a2a2a]'
                    }`}
                    whileTap={{ scale: 0.95 }}
                  >
                    <motion.div
        ...
        >
          <div className="bg-[#1a1a1a]/80 backdrop-blur-lg rounded-xl border border-[#2a2a2a] p-6">
            <div className="flex items-center space-x-2 mb-6">
              <Globe className="w-5 h-5" style={{ color: currentTheme.color }} />
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <motion.button
                  ...
                  className={`w-12 h-6 rounded-full relative ${
                    settings.darkMode ? 'theme-bg' : 'bg-[#2a2a2a]'
                  }`}
                  whileTap={{ scale: 0.95 }}
                >
                  <motion.div
              ...
              <div className="flex items-center justify-between">
                ...
                <motion.button
                  ...
                  className={`w-12 h-6 rounded-full relative ${
                    settings.soundEffects ? 'theme-bg' : 'bg-[#2a2a2a]'
                  }`}
                  whileTap={{ scale: 0.95 }}
                >
                  <motion.div
              ...
              <div className="flex items-center justify-between">
                ...
                <motion.button
                  ...
                  className={`w-12 h-6 rounded-full relative ${
                    settings.emailUpdates ? 'theme-bg' : 'bg-[#2a2a2a]'
                  }`}
                  whileTap={{ scale: 0.95 }}
                >
                  <motion.div
          ...
          <div className="bg-[#1a1a1a]/80 backdrop-blur-lg rounded-xl border border-[#2a2a2a] p-6">
            <div className="flex items-center space-x-2 mb-6">
              <Lock className="w-5 h-5" style={{ color: currentTheme.color }} />
